...
class BeeDataset(utils.Dataset):
    ...
    def load_bee(self, dataset_dir, subset):
        """Load a subset of the Bee dataset.
        ...
        dataset_dir = os.path.join( dataset_dir, subset).replace("\\","/")
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "via_region_data.json").replace("\\","/")))
        ...
        for a in annotations:
            ...
            image_path = os.path.join(dataset_dir, a['filename']).replace("\\","/")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Ethoflow to detect bees.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/bee/dataset/",
                        help='Directory of the Bee dataset')
